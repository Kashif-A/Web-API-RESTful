   ...
   <body>
      ...
      <div class="container">
         ...
         <div class="row create">
            <div class="col-md-6 text-center" style="padding: 25px; background-color: #cbfcb2;">
               <h4><em><strong>(HTTP Get Request)</strong></em></h4>
               <p>Fill fields to add film...</p><br>
               <div class="addForm text-right" style="margin-right: 20px;">
                  <form method="GET" action="createfilm">
                  	<fieldset>
      ...
      <script type="text/javascript">
         ...
         // Function to generate JSON object from POST request form and send it to server
         // to add film using JSON object.
         ...
         $.ajax({
            ...
            success: function (result) {
              ...
              $("#linkUsed").html("<strong><em><h3>JSON Object sent: </h3></strong></em>" + JSONForServer +
            		  			  "<br><br><hr><strong><em><h3>POST request sent successfully to url: </h3></em></strong>" + url + 
