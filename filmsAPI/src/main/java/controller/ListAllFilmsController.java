...
/**
 * Controller to list all films and send the films as JSON, XML, TEXT or CSV format
...
public class ListAllFilmsController extends HttpServlet {
	...
	@ResponseBody
	public String listFilms(@RequestParam("datatype") String typeOfData, HttpServletResponse response, HttpServletRequest request) {
